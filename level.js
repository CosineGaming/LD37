...
Level.prototype.draw = function()
{
	...
	var levelText = game.make.retroFont("arabic", 12, 16, Phaser.RetroFont.TEXT_SET1);
	storedStage.addChild(game.make.image(225, 4, levelText));
	levelText.text = "Level:" + this.storedLevel;
...
// Called evry time the level is set
